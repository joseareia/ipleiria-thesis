...
\SupervisorMail{joe.smith@ulo.pt}
% Please provide: [Current Title, Affiliation]
\SupervisorTitle{Full Professor, University of Leiria and Oeste}

% Co-Supervisor (Optional)
\CoSupervisor{Steve Smith}
\CoSupervisorMail{steve.smith@ulo.pt}
\CoSupervisorTitle{Associate Professor, University of Leiria and Oeste}

% Second Co-Supervisor (Optional)
\SecCoSupervisor{Shak Smith}
\SecCoSupervisorMail{shak.smith@ulo.pt}
