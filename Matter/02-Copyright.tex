...
\ifthenelse{\equal{\LanguageOption}{portuguese}}{%
    ...
    \noindent La presente disertación es un trabajo original, elaborado exclusivamente para este fin, habiendo sido debidamente citados todos los autores cuyos estudios contribuyeron a su elaboración. Se permite su reproducción parcial con indicación del autor y referencia al grado, año académico, institución---\textit{Universidade de Leiria e Oeste}---y fecha de defensa pública.
