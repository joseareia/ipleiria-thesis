\ifthenelse{\equal{\AiAckOption}{true}}{%
    \ifthenelse{\equal{\LanguageOption}{portuguese}}{%
        ...
        \guideinfo{Considera-se boa prática académica incluir uma breve declaração que reconheça como, porquê e quando foram utilizadas tecnologias de inteligência artificial. Articular claramente não só o que foi feito, mas também a lógica subjacente, incentiva uma abordagem mais crítica e reflexiva da seleção e utilização de tais ferramentas. Esta prática também promove uma compreensão mais profunda do papel da IA no processo de aprendizagem e ajuda a avaliar o seu impacto na qualidade e integridade do seu trabalho.}
        ...
        \guideinfo{It is considered good academic practice to include a brief statement acknowledging how, why, and when AI technologies have been used. Clearly articulating not only what was done, but also the rationale behind it, encourages a more critical and reflective approach to the selection and use of such tools. This practice also fosters a deeper understanding of the role of AI in the learning process and helps to evaluate its impact on the quality and integrity of your work.}
